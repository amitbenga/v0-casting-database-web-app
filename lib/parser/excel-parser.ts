...
// Backward-compatible wrappers around the generic structured-parser functions.
...
/** Legacy mapping type — sheetIndex selects which ExcelSheet to use */
export interface ScriptLineColumnMapping extends StructuredColumnMapping {
  sheetIndex: number
}

/**
 * Auto-detect column mapping from sheet headers.
 * Delegates to the generic autoDetectColumns from structured-parser.
 */
 ...
 * Delegates to parseScriptLinesFromStructuredData for the actual conversion.
 */
