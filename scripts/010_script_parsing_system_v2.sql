...
CREATE TABLE IF NOT EXISTS role_castings (
    ...
    project_id TEXT REFERENCES casting_projects(id) ON DELETE CASCADE,
...
DROP POLICY IF EXISTS "Enable read access for all users" ON role_castings;
CREATE POLICY "Enable read access for all users" ON role_castings FOR SELECT USING (true);
DROP POLICY IF EXISTS "Enable insert for all users" ON role_castings;
CREATE POLICY "Enable insert for all users" ON role_castings FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Enable update for all users" ON role_castings;
CREATE POLICY "Enable update for all users" ON role_castings FOR UPDATE USING (true);
DROP POLICY IF EXISTS "Enable delete for all users" ON role_castings;
...
DROP POLICY IF EXISTS "Enable read access for all users" ON role_conflicts;
CREATE POLICY "Enable read access for all users" ON role_conflicts FOR SELECT USING (true);
DROP POLICY IF EXISTS "Enable insert for all users" ON role_conflicts;
CREATE POLICY "Enable insert for all users" ON role_conflicts FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Enable update for all users" ON role_conflicts;
CREATE POLICY "Enable update for all users" ON role_conflicts FOR UPDATE USING (true);
DROP POLICY IF EXISTS "Enable delete for all users" ON role_conflicts;
